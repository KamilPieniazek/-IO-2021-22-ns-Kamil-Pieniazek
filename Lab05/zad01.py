...
# # uzupelnionione zerami = kolor czarny
...
#
# # zamalowanie 4 pikseli w lewym nym rogu
# draw(data, 5, 5, 100)
# draw(data, 6, 6, 100)
# draw(data, 5, 6, 255)
# draw(data, 6, 5, 255)
...
# tworzymy tablice o wymiarach 128x128x3 (3 kanaly to RGB)i
data = np.zeros((128, 128, 3), dtype=np.uint8)
